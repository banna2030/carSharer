<#include "header.ftl">
    ...
    <div class="card-body">
<div class="d-flex">
    <img src=${icon} class="rounded-circle d-block mr-3 alt="Driver" ;
...
<#list driveInformation as di>
    ...
    <button type="button" onclick="window.location='new_rating?FID=${di.getFID()}';"
            class="btn btn-primary d-block mb-2" style="float:right">Fahrt bewerten
    </button>
</#list>
    </div>
    </div>
